...
#    Updated: 2022/02/24 12:32:08 by goliano-         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS	= 	srcs/minishell.c srcs/prompt/prompt.c srcs/lexer/lexer.c srcs/lexer/parser_lexer.c \
			...
			utils/tokens/tokens.c ./utils/str/strings.c ./utils/str/strings2.c ./utils/chequer/chequer.c ./utils/lengths/lengths.c
